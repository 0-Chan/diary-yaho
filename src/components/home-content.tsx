  ...
  return (
    <main className="min-h-svh bg-background px-4 pt-6 pb-4 text-foreground sm:px-6">
      <div className="mx-auto flex min-h-[calc(100svh-2.5rem)] w-full max-w-[430px] flex-col gap-5">
        ...
        <nav
          aria-label="주요 메뉴"
          className="mt-auto grid grid-cols-4 gap-1 rounded-lg border border-line bg-surface px-3 pt-3 pb-[calc(env(safe-area-inset-bottom)+0.75rem)] shadow-[0_-8px_22px_rgba(65,45,24,0.08)]"
        >
          {tabItems.map((item) => {
